...
PmergeMe::PmergeMe(const std::vector<int>& vec): _vec(vec.begin(), vec.end()), _deq(vec.begin(), vec.end())
{
}

PmergeMe::PmergeMe(const PmergeMe& ref): _vec(ref._vec), _deq(ref._deq)
{
}
